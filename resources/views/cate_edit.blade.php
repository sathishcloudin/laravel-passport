...
<body>
  <form method="post" action="/cate_update"> 
    @csrf
    <input type="hidden" name="id" value="{{$cateuser['id']}}">  
<div class="container">
  <form method="post" > 
    @csrf 
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="name" name="name" placeholder="category Name.."value="{{$cateuser['name']}}">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
