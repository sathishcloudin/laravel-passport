...
<div class="container">
  <form method="post" action="/update">  
    @csrf
    <input type="hidden" name="id" value="{{$Newsuser['id']}}">  
    <div class="row">
        <div class="col-25">
          <label for="name">category Name</label>
          </div>
          <div class="col-75">
          <input type="text" id="name" name="category_id" placeholder="category Name.." value="{{$Newsuser['category_id']}}">
        </div>
      </div>
    <div class="row">
      <div class="col-25">
        ...
        <div class="col-75">
        <input type="text" id="name" name="news_title" placeholder="short News.." value="{{$Newsuser['news_title']}}">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        ...
        <div class="col-75">
        <textarea type="text" id="name" name="news_discussion" placeholder="News Discussion.." value="{{$Newsuser['news_discussion']}}"></textarea>
      </div>
    </div>
