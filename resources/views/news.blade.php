...
<div class="container">
  <form method="post" action="{{route('news')}}">  
      ...
      <div class="col-25">
        ...
        <div class="col-75">
          <select name="category_id">
            {{-- enga foreach use panniruken user --}}
            @foreach($cat as $user)
    ...
    <div class="row">
      <div class="col-25">
        ...
        <div class="col-75">
        <input type="text" id="name" name="news_title" placeholder="short News..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        ...
        <div class="col-75">
        <textarea type="text" id="name" name="news_discussion" placeholder="News Discussion.."></textarea>
      </div>
    </div>
 ...
 <div class="container">
  <h2 class="text-center">View News</h2>
<!-- table view -->
  <table class="table table-bordered table-striped" border="2">
    ...
    <tbody>
      @foreach ($news_data as $user)
      <tr>
        <td>{{ $user->id }}</td>
        <td>{{ $user->name }}</td>
        <td>{{ $user->news_title }}</td>
        <td>{{ $user->news_discussion }}</td>
